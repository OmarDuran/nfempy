...
def test_edge_edge_intersection():
    ...
    # No intersection
    out_0 = edge_edge_intersection(e0, e1)
    out_1 = edge_edge_intersection(e1, e0)
    assert out_0 == out_1 # Intersection is commutative
    ...
    out_0 = edge_edge_intersection(e0, e1)
    out_1 = edge_edge_intersection(e1, e0)
    assert vertex_with_same_geometry_q(out_0, out_1) # Intersection is commutative
