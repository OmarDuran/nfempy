        ...
        return lambda x, y, z: np.array(
            [
                [
                    ...
                    (
                        (
                            -((np.pi**2) * (m_kappa_s + m_mu_s))
                            + (np.pi**2)
                            * (5 * m_kappa_s - 3 * m_mu_s)
                            * np.cos(2 * np.pi * x)
                            - 4 * m_kappa_s * np.sin(np.pi * x)
                        )
                        * np.sin(np.pi * y)
                    )
                    / 2.0,
                ...
                [
                    ...
                    * (
                        ...
                        * np.sin(np.pi * z)
                        + (np.pi**2)
                        * (
                            m_mu_s * (np.cos(np.pi * x) ** 2)
                            - m_kappa_s * np.cos(2 * np.pi * x)
                        )
                        * (np.sin(np.pi * y) ** 2)
                        * (np.sin(np.pi * z) ** 2)
                        + (np.pi**2)
                        ...
                        * np.sin(np.pi * y)
                        * (
                            m_kappa_s * np.cos(np.pi * (y - z)) * np.sin(np.pi * z)
                            + m_mu_s * np.cos(np.pi * y) * np.sin(2 * np.pi * z)
                        )
                    ),
                ],
                [
                    -2
                    * (
                        (-1 + z) * z * m_kappa_s * np.sin(np.pi * x) * np.sin(np.pi * y)
                        - (np.pi**2)
                        * (m_kappa_s - m_mu_s)
                        * (np.sin(np.pi * x) ** 2)
                        * np.sin(np.pi * (2 * y - z))
                ...
                [
                    ...
                    * (
                        ...
                        * np.sin(np.pi * (y - z))
                        + np.sin(np.pi * z)
                        * (
                            (-1 + y) * y * m_kappa_s * np.sin(np.pi * x)
                            - (np.pi**2)
                            * (m_kappa_s - m_mu_s)
                            * np.cos(np.pi * (y - z))
                            * (np.sin(np.pi * x) ** 2)
    ...
    if dim == 2:
        return lambda x, y, z: np.array(
            [
                (
                    ...
                    * (
                        -((np.pi**2) * (m_kappa_s + m_mu_s))
                        + 5 * (np.pi**2) * (m_kappa_s + m_mu_s) * np.cos(2 * np.pi * x)
                        - 4 * m_kappa_s * np.sin(np.pi * x)
                    )
                )
                / 2.0,
                ...
                * (
                    m_kappa_s
                    + 5 * (np.pi**2) * (m_kappa_s + m_mu_s) * np.sin(np.pi * x)
                )
                * np.sin(np.pi * y),
                (
                    -((np.pi**2) * m_kappa_s)
                    + 5 * (np.pi**2) * m_kappa_s * np.cos(2 * np.pi * x)
                    - 2
        ...
        return lambda x, y, z: np.array(
            [
                ...
                * np.pi
                * (
                    (-1 + z) * z * m_kappa_s * np.cos(np.pi * y) * np.sin(np.pi * x)
                    - (-1 + y) * y * m_kappa_s * np.cos(np.pi * z) * np.sin(np.pi * x)
                    + (np.pi**2)
                    * (m_kappa_s + m_mu_s)
                    * (np.cos(np.pi * z) ** 2)
                    * (np.sin(np.pi * x) ** 2)
                ...
                * (
                    ...
                    * np.sin(np.pi * z)
                    * (
                        (-1 + y) * y * m_kappa_s * np.cos(np.pi * x)
                        - (-1 + x) * x * m_kappa_s * np.cos(np.pi * y)
                        + (np.pi**2)
                        * (m_kappa_s + m_mu_s)
                        * (np.cos(np.pi * y) ** 2)
                        * np.sin(2 * np.pi * x)
                ...
                2
                * (
                    -(m_l * (np.pi**2) * x * m_kappa_o)
                    + m_l * (np.pi**2) * (x**2) * m_kappa_o
                    - 2 * x * m_kappa_s
                    + 2 * (x**2) * m_kappa_s
                    - m_l * m_lambda_o
                    - 2 * m_l * m_mu_o
                    - m_l * (np.pi**2) * x * m_mu_o
                    + m_l * (np.pi**2) * (x**2) * m_mu_o
                    - (np.pi**2) * m_kappa_s * np.cos(np.pi * (2 * x - y - z))
                    + (np.pi**2) * m_kappa_s * np.cos(np.pi * (2 * x + y + z))
                )
                * np.sin(np.pi * y)
                * np.sin(np.pi * z)
                ...
                * np.cos(np.pi * x)
                * ((-1 + 2 * z) * np.sin(np.pi * y) + (-1 + 2 * y) * np.sin(np.pi * z)),
                4
                * (np.pi**2)
                * m_kappa_s
                * (np.cos(np.pi * z) ** 2)
                ...
                * (m_kappa_o - m_lambda_o - m_mu_o)
                * np.cos(np.pi * y)
                * ((-1 + 2 * z) * np.sin(np.pi * x) + (-1 + 2 * x) * np.sin(np.pi * z))
                + 2
                * np.sin(np.pi * z)
                * (
                    (
                ...
                * (m_kappa_o - m_lambda_o - m_mu_o)
                * np.cos(np.pi * z)
                * ((-1 + 2 * y) * np.sin(np.pi * x) + (-1 + 2 * x) * np.sin(np.pi * y))
                - 4
                * (np.pi**2)
                * m_kappa_s
                * (np.sin(np.pi * x) ** 2)
