...
def get_exact_functions_by_co_dimension(
    ...
    if co_dimension == 0:
        exact_functions = {
            flux_name: partial(u_exact, m_c1=m_c1, m_c2=m_c2, m_kappa_c0=m_kappa_c0, m_kappa_c1=m_kappa_c1, m_delta=m_delta),
            potential_name: partial(p_exact, m_c1=m_c1, m_c2=m_c2, m_kappa_c0=m_kappa_c0, m_kappa_c1=m_kappa_c1, m_delta=m_delta),
        }
    elif co_dimension == 1:
        exact_functions = {
            flux_name: partial(u_f_exact, m_c1=m_c1, m_c2=m_c2, m_kappa_c0=m_kappa_c0, m_kappa_c1=m_kappa_c1, m_delta=m_delta),
...
def get_rhs_by_co_dimension(co_dimension, rhs_name, m_c1, m_c2, m_kappa_c0, m_kappa_c1, m_delta):
    if co_dimension == 0:
        rhs_functions = {
            rhs_name: partial(f_c0_rhs, m_c1=m_c1, m_c2=m_c2, m_kappa_c0=m_kappa_c0, m_kappa_c1=m_kappa_c1, m_delta=m_delta),
        }
    elif co_dimension == 1:
        rhs_functions = {
            rhs_name: partial(f_c1_rhs, m_c1=m_c1, m_c2=m_c2, m_kappa_c0=m_kappa_c0, m_kappa_c1=m_kappa_c1, m_delta=m_delta),
        }
    else:
        raise ValueError("Case not available.")
