...
def plot_over_line(figure_file_name):
    ...
    b = [1.0, 0.0, 0.0]
    file_name_geo = "geometric_mesh_1d.vtk"
    # file_name = "mixed_rt_c_1_material_parameters_0.1_0.02_1.0_99999.99999999999_1.0_1.0_1e-05_1.0_1.0_1.0_mesh_size_0.0078125_md_elliptic_physical_two_fields.vtk"
    file_name = "mixed_rt_c_1_material_parameters_0.1_0.02_1.0_99999.99999999999_1.0_1.0_1e-05_1.0_1.0_1.0_mesh_size_0.0078125_md_elliptic_two_fields.vtk"
    # load data
    hdiv_solution = pyvista.read(file_name)
...
canvas.save_graphic("md_degenerate_figures/uh_ue_1e-5_magnitude.pdf")
# canvas.save_graphic("md_degenerate_figures/ph_pe_1e-5_magnitude.pdf")
# canvas.save_graphic("md_degenerate_figures/vh_ve_1e-5_magnitude.pdf")
# canvas.save_graphic("md_degenerate_figures/qh_qe_1e-5_magnitude.pdf")
