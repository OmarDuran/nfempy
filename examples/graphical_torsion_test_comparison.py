...
def paint_on_canvas():
    ...
    plotter.add_mesh(h1_solution, scalars=u_h_norm, cmap='balance', show_edges=True, scalar_bar_args = sargs)
    ...
    plotter.add_mesh(arrows, cmap='balance')
    plotter.remove_scalar_bar("GlyphScale")
    plotter.add_mesh(hdiv_solution, scalars = u_h_norm,cmap='balance', show_edges=True, scalar_bar_args = sargs)
