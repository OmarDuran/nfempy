    ...
    if dim == 2:
        return lambda x, y, z: np.array(
            [
                ...
                * m_mu
                * (
                    3 * np.sin(4 * np.pi * (x - y))
                    - 2 * (-2 + np.cos(4 * np.pi * x)) * np.sin(4 * np.pi * y)
                    - 3 * np.sin(4 * np.pi * (x + y))
                ),
                -16
                * (np.pi**3)
                * m_mu
                * (
                    2 * (-2 + np.cos(4 * np.pi * y)) * np.sin(4 * np.pi * x)
                    + 3 * (np.sin(4 * np.pi * (x - y)) + np.sin(4 * np.pi * (x + y)))
                ),
                24
                * (np.pi**2)
                * m_mu
