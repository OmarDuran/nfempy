        ...
        return lambda x, y, z: np.array(
            [
                [
                    ...
                    * np.pi
                    * (
                        (m_lambda + 2 * m_mu) * np.cos(2 * np.pi * x)
                        + m_lambda * np.cos(2 * np.pi * y)
                    ),
                ...
                [
                    ...
                    * np.pi
                    * (
                        m_lambda * np.cos(2 * np.pi * x)
                        + (m_lambda + 2 * m_mu) * np.cos(2 * np.pi * y)
                    ),
                ],
            ]
        )
    ...
    if dim == 2:
        return lambda x, y, z: np.array(
            [
                -4
                * np.pi
                * (np.pi * (m_lambda + 2 * m_mu) + m_mu * np.cos(2 * np.pi * y))
                * np.sin(2 * np.pi * x),
                4
                * np.pi
                * (-(np.pi * (m_lambda + 2 * m_mu)) + m_mu * np.cos(2 * np.pi * x))
                * np.sin(2 * np.pi * y),
