...
class LaplacePrimalWeakFormBCDirichlet(WeakForm):
    def evaluate_form(self, element_index, alpha):
        ...
        # basis functions evaluated directly on the BC element (trace of the
        # Lagrange space is itself a Lagrange space on the boundary entity)
        ...
        # penalty Dirichlet enforcement:  beta * (p_h - p_D, q_h)_Gamma
        beta = 1.0e12
